...
public class MsgVpnBridgeRemoteMsgVpn {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The location of the Remote Message VPN. This may be given as either a hostname (resolvable via DNS), IP Address, or virtual router-name (starts with 'v:'). If specified as a hostname or IP Address, a port must be specified as well.")
